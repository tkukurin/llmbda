...
@pytest.mark.parametrize("make_skill", [
    lambda fn: Skill("dup", steps=[Skill("same", fn=fn), Skill("same", fn=fn)]),
    lambda fn: Skill("s", steps=[
        Skill("same", fn=fn, steps=[Skill("child", fn=fn)]),
        Skill("same", fn=fn),
    ]),
    lambda fn: Skill("s", steps=[
        Skill("orch", fn=fn, steps=[Skill("same", fn=fn), Skill("same", fn=fn)]),
    ]),
...
@pytest.mark.parametrize("prompt,expected", [
    ("be terse", [[{"role": "system", "content": "be terse"}, {"role": "user", "content": "hi"}]]),
...
@pytest.mark.parametrize("fn,expected_name,expected_value", [
